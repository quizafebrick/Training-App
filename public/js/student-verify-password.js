...
function verifyOldPassword() {
    ...
    if (oldPassword.trim() === "") {
        ...
        return; // * EXIT THE FUNCTION TO PREVENT THE PROMISE REQUEST * //
    }

    // * MAKE A PROMISE POST REQUEST TO VERIFY THE OLD PASSWORD * //
            ...
            if (data.show_change_password) {
                ...
                (oldPasswordInput.disabled = true),
                    (oldPasswordInput.className =
                        "bg-gray-200 cursor-not-allowed border border-gray-300 text-gray-900 text-lg rounded-lg block w-full p-2.5");

                const verifyBtn = document.getElementById("verify-btn");
                verifyBtn.className = "hidden";
            } else {
