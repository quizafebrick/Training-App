            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        {{-- * DELETE BUTTON * --}}
                        <a href="#"
                            class="flex items-center justify-center px-3 py-2 mb-2 mr-2 text-sm font-medium text-white bg-red-700 rounded-lg hover:bg-red-800 hover:duration-300 delete-btn"
